...
.appendTo(parent).fadeIn('fast').click(function()
{ 
	$(this).remove(); 
})
valid = false;
...
if ( valid != false )
{
    ...
    var jsonData = JSON.stringify(data); 
     ...
     $.post( "TestServlet", { theNameOfTheParameter: jsonData },
      function( data ) {
        if ( data.IsAuthenticated == "yes" )
        {
                alert(data.InputParam);
                window.location = "index.jsp";
        }
        else
        {
            $('#loginFailed').html('The username or password you entered is incorrect')
